...
## [7.0.0](https://github.com/axelcypher/obsidian-mapbox/compare/v6.0.5...7.0.0) (2026-09-22)
...
* add settings to change default tile servers ([043e248](https://github.com/axelcypher/obsidian-mapbox/commit/043e248c7d17bd17374527b5a5838c41fd6f12dc))
* added `preserveAspect` map parameter (close [#254](https://github.com/axelcypher/obsidian-mapbox/issues/254)) ([e507416](https://github.com/axelcypher/obsidian-mapbox/commit/e5074160a62c1ad6b8dde5bc0c8bbcd2260efa5d))
* added `tileOverlay` map option to specify tile servers as map overlays ([eec6368](https://github.com/axelcypher/obsidian-mapbox/commit/eec636861baaf1add50182d301ef033ec2ddf865))
* added `width` parameter (close [#262](https://github.com/axelcypher/obsidian-mapbox/issues/262)) ([d2d2a22](https://github.com/axelcypher/obsidian-mapbox/commit/d2d2a2252c0e06893b99e7c377bc4f6648b7d829))
* added noUI parameter ([452dbc2](https://github.com/axelcypher/obsidian-mapbox/commit/452dbc2347a10d3af64137c1cda22f3fd989beb0))
* adds ability to force map to recenter when dragged ([057f9c6](https://github.com/axelcypher/obsidian-mapbox/commit/057f9c61e54b2d01fabaf9299b72bb5f5a2452ab))
* Adds description field + reorganizes Edit Marker modal ([b1a648f](https://github.com/axelcypher/obsidian-mapbox/commit/b1a648feeff2b171c824e7f2349d5e62fa21bf6c))
* adds noScrollZoom block parameter ([a8b607f](https://github.com/axelcypher/obsidian-mapbox/commit/a8b607fe234e14c2c247bfa89f25999716ccb2a7))
* Adds support for markdown links in addition to wikilinks (close [#280](https://github.com/axelcypher/obsidian-mapbox/issues/280)) ([c903209](https://github.com/axelcypher/obsidian-mapbox/commit/c9032096810b908c768a093769fce7401ce08d40))
* can alt-click to measure polylines from drawing ([6bc541f](https://github.com/axelcypher/obsidian-mapbox/commit/6bc541f859c46f4ce52be8a4df602f935ef94e1c))
* can now link geojson to notes ([9eb6b2a](https://github.com/axelcypher/obsidian-mapbox/commit/9eb6b2a24993dd55044ecd16df9de8e4ab495c75))
* Can now measure in segments by continuing to mod-click ([fbdf5f0](https://github.com/axelcypher/obsidian-mapbox/commit/fbdf5f095722b408ce4899bca9e8a23555a57111))
* can now specify layer for code block markers ([ebcec59](https://github.com/axelcypher/obsidian-mapbox/commit/ebcec59d4b57e259c91d21f254ad1866406cc26c))
* Define custom marker types in json files ([#400](https://github.com/axelcypher/obsidian-mapbox/issues/400)) ([b9305f5](https://github.com/axelcypher/obsidian-mapbox/commit/b9305f50529e862df1359a46641bf8b0280c5b49))
* Enable marker opacity (close [#334](https://github.com/axelcypher/obsidian-mapbox/issues/334)) ([59f26dc](https://github.com/axelcypher/obsidian-mapbox/commit/59f26dc7c6ab236fae50a942239f60589b8a50b7))
* maps can now be locked to prevent editing ([25befa7](https://github.com/axelcypher/obsidian-mapbox/commit/25befa710a2d73ab02952281d23864e51a207a4a))
* Marker double-clicks now open the edit marker modal ([1c01511](https://github.com/axelcypher/obsidian-mapbox/commit/1c01511e9e6869dc58df54d5199990175de99749))
* Mobile measuring added to map long-press menu ([525ae2d](https://github.com/axelcypher/obsidian-mapbox/commit/525ae2dbd9fb503a17ab28e36eafb0b6aa15a72f))
* much improved image loading ([08c80ed](https://github.com/axelcypher/obsidian-mapbox/commit/08c80ed73b44ab870d0ae5d4b7947b4690400bec))
* now show current zoom level on Reset Zoom control ([e53ace5](https://github.com/axelcypher/obsidian-mapbox/commit/e53ace5a4b83765f45b5b86e091a1ff07c6ce29a))
* OpenStreetMap has restricted use of its tile server in Obsidian. The default tile server for Obsidian Leaflet has been changed to Stamen Terrain. Please see [#286](https://github.com/axelcypher/obsidian-mapbox/issues/286) for more information. (close [#286](https://github.com/axelcypher/obsidian-mapbox/issues/286)) ([3b33092](https://github.com/axelcypher/obsidian-mapbox/commit/3b33092ddf540d444033a2457e3fe6d7c68867f5))
* Switched map tile provider (close [#424](https://github.com/axelcypher/obsidian-mapbox/issues/424)) ([c80da47](https://github.com/axelcypher/obsidian-mapbox/commit/c80da47a82c0486072a3d3ecce6078856394ae43))
* testing changelog for claire ([a7d6464](https://github.com/axelcypher/obsidian-mapbox/commit/a7d64644c54714ab386bc0f489f779a95e826148))
* tile layers can now default on with the `|on` flag ([f5a4e56](https://github.com/axelcypher/obsidian-mapbox/commit/f5a4e565f0b86528af66bb4af2b69160ca63c89a))


### Bug Fixes

* adds copy coordinates to mobile context menu ([400894f](https://github.com/axelcypher/obsidian-mapbox/commit/400894f41c16fac2259ed00b952f4767a224a63f))
* adds plugin as link hover source ([ada3e64](https://github.com/axelcypher/obsidian-mapbox/commit/ada3e64627b5472c185ce4949135b94b70dd2e95))
* adds small dropshadow to markers (close [#363](https://github.com/axelcypher/obsidian-mapbox/issues/363)) ([8badcaf](https://github.com/axelcypher/obsidian-mapbox/commit/8badcaf57981198c3d544f2b769590c39190ebfd))
* apply zoomMarkers on first render ([#467](https://github.com/axelcypher/obsidian-mapbox/issues/467)) ([a26e36b](https://github.com/axelcypher/obsidian-mapbox/commit/a26e36bd5d2bdfb3f930562f427241327d306e6e))
* bug with naming of new tileoverlays ([7398e5d](https://github.com/axelcypher/obsidian-mapbox/commit/7398e5d594b17465e0136b855968da9957b8ce9b))
* clean up settings ([#381](https://github.com/axelcypher/obsidian-mapbox/issues/381)) ([4df1590](https://github.com/axelcypher/obsidian-mapbox/commit/4df15901d65916101ecb7aa2e96d2e825d8657f9))
* decorate leaflet sourced hover-popovers ([617d69f](https://github.com/axelcypher/obsidian-mapbox/commit/617d69f7d2e2e7d0402f8dd33ab4b5935bbed15d))
* default to infinite recursion for geojson (close [#366](https://github.com/axelcypher/obsidian-mapbox/issues/366)) ([ad2b37a](https://github.com/axelcypher/obsidian-mapbox/commit/ad2b37a49af93531aaccd7ef99c6dbe0dcc2a95a))
* display geojson causing error in notice ([174b80d](https://github.com/axelcypher/obsidian-mapbox/commit/174b80d6311e257fd1e468ebc5223f0c9672b3ac))
* Displays GPX tracks on load ([fe79ca0](https://github.com/axelcypher/obsidian-mapbox/commit/fe79ca0060aec2f3fdc0d0391885c9f876cfc2ea))
* expand local links for obsidian's hover-preview (closes [#361](https://github.com/axelcypher/obsidian-mapbox/issues/361)) ([#375](https://github.com/axelcypher/obsidian-mapbox/issues/375)) ([c145fdd](https://github.com/axelcypher/obsidian-mapbox/commit/c145fdd464346e7084e276ae03f0b378172245d5))
* fix release version ([a3b4c44](https://github.com/axelcypher/obsidian-mapbox/commit/a3b4c44b3cc68d7644781e937e9f24f4b634340e))
* fix-version ([bf3801e](https://github.com/axelcypher/obsidian-mapbox/commit/bf3801e2901690c34504c97c721b231da28ae5af))
* fixed issue where drag and drop was not linking note to marker ([f9261e3](https://github.com/axelcypher/obsidian-mapbox/commit/f9261e388a2a0238fbf81532bcfec6cc4c9af1b6))
* Fixed issue where setting a marker description could also set the link ([138d59b](https://github.com/axelcypher/obsidian-mapbox/commit/138d59bdb9e91ff6493d6c24e6c6135a131e1133))
* fixed issue with non-tileoverlay maps ([c6a8726](https://github.com/axelcypher/obsidian-mapbox/commit/c6a87269e4de1a0ac4909030f483ea23ee357985))
* fixed issue with tile overlay ([22da6cc](https://github.com/axelcypher/obsidian-mapbox/commit/22da6cc8adde8d8ad0a5a3109084c5b3514abb26))
* Fixes another instance where image markers might not resize properly ([f75836a](https://github.com/axelcypher/obsidian-mapbox/commit/f75836ac66185c7e2794009b51911a9e831caf46))
* fixes appearance of native context menus ([a70a041](https://github.com/axelcypher/obsidian-mapbox/commit/a70a0415c84a2d925799f048a2151152ecbc772d))
* fixes control order when just using tileoverlays ([8bbce58](https://github.com/axelcypher/obsidian-mapbox/commit/8bbce58807fac4638cc8fe1a829b6193beea50cc))
* fixes copy on shift-click ([f623074](https://github.com/axelcypher/obsidian-mapbox/commit/f62307466c2695c1ff2f93e5f2bbd89fbd0230b4))
* Fixes GPX tooltip not inheriting map units (close [#288](https://github.com/axelcypher/obsidian-mapbox/issues/288)) ([8640245](https://github.com/axelcypher/obsidian-mapbox/commit/8640245f87428a239b81bca13dce4230fcf4b880))
* fixes hover popover decoration ([734dd67](https://github.com/axelcypher/obsidian-mapbox/commit/734dd676d0562b29e2e33d14823a9bfb3d0eceed))
* Fixes icons not rendering due to SVG mask duplication (close [#293](https://github.com/axelcypher/obsidian-mapbox/issues/293)) ([6e95de5](https://github.com/axelcypher/obsidian-mapbox/commit/6e95de573634887de500caed78a8a10b8155dad1))
* fixes incorrect use of Set ([b3f5c47](https://github.com/axelcypher/obsidian-mapbox/commit/b3f5c47473e3c4f3c25be85f5b0de7f12b2a2506))
* fixes issue preventing map view from opening ([3b2ecee](https://github.com/axelcypher/obsidian-mapbox/commit/3b2ecee45454f65f0107b23d5878c7a48babc425))
* Fixes issue where marker types deleted in settings would crash the plugin ([bacc370](https://github.com/axelcypher/obsidian-mapbox/commit/bacc37086f5822832eb5346c0312465b62178b0c))
* fixes longitude i10n message ([97adff3](https://github.com/axelcypher/obsidian-mapbox/commit/97adff3007a4e75ae0efa67923d61ab05eae94cd))
* Fixes some instances where custom marker images were not resized ([505e3b2](https://github.com/axelcypher/obsidian-mapbox/commit/505e3b2f3b0334025cd796896ce0e98aa9902979))
* fixes source issue for hover-link ([4e60236](https://github.com/axelcypher/obsidian-mapbox/commit/4e60236e13134f3a79ac5b07a4e468c409dc21bf))
* geojson and gpx now default to the file name [#263](https://github.com/axelcypher/obsidian-mapbox/issues/263) ([4e9b72b](https://github.com/axelcypher/obsidian-mapbox/commit/4e9b72b04ca25f4504f19c742f6dbb9b3fbb87cc))
* gpxFolder incorrect gpx collection ([#364](https://github.com/axelcypher/obsidian-mapbox/issues/364)) ([255d46f](https://github.com/axelcypher/obsidian-mapbox/commit/255d46f40ff61c4de381ab871845c1af9ad9e4ad))
* index bug ([e11f663](https://github.com/axelcypher/obsidian-mapbox/commit/e11f663b1eac24e2d499b84c64e3e3895b682238))
* Inspect document body for theme instead of vault config (close [#440](https://github.com/axelcypher/obsidian-mapbox/issues/440)) ([fa1a3f4](https://github.com/axelcypher/obsidian-mapbox/commit/fa1a3f42ebee556ca1427ec637f1522a09bba0e2))
* invalidate map size to prevent incorrect starting positions in some situations ([a9ac194](https://github.com/axelcypher/obsidian-mapbox/commit/a9ac1949d7aad283050afab339253d0e141f7fba))
* latidude and longitude can be set (closes [#373](https://github.com/axelcypher/obsidian-mapbox/issues/373)) ([#374](https://github.com/axelcypher/obsidian-mapbox/issues/374)) ([d92df41](https://github.com/axelcypher/obsidian-mapbox/commit/d92df4181998be02556571108febb397e58b253e))
* latitude and longitude can be 0 (close [#362](https://github.com/axelcypher/obsidian-mapbox/issues/362)) ([deff0a8](https://github.com/axelcypher/obsidian-mapbox/commit/deff0a810ca5416e885feace4b0bebc62eeb5128))
* lock state persists ([d6436b1](https://github.com/axelcypher/obsidian-mapbox/commit/d6436b1cb4ad324174db81428b76f620aff0f71a))
* map now respects cmd-hover ([cd2142e](https://github.com/axelcypher/obsidian-mapbox/commit/cd2142e23c4a187d307be21b6fc571ca9b93ec82))
* Marker descriptions now displayed in tooltip even if there is a link ([bd9a200](https://github.com/axelcypher/obsidian-mapbox/commit/bd9a200c23f46898e84287e4ebb9c33a98ac848e))
* Marker tooltips should hide when a layer is changed ([19d5765](https://github.com/axelcypher/obsidian-mapbox/commit/19d5765073cbfd022f178b64c4a995c69b0a3272))
* markers should respect layers when reset now (close [#308](https://github.com/axelcypher/obsidian-mapbox/issues/308)) ([fcf974a](https://github.com/axelcypher/obsidian-mapbox/commit/fcf974aef7b6042a3b9cf3bbd3b1386116c40328))
* markers with only descriptions will display their popup (close [#253](https://github.com/axelcypher/obsidian-mapbox/issues/253)) ([ceb8498](https://github.com/axelcypher/obsidian-mapbox/commit/ceb8498b0cd50b55ed1aca9c7baaec92f5251bae))
* removed console logs ([34feb92](https://github.com/axelcypher/obsidian-mapbox/commit/34feb92e040a1d2a2e3896f2dddec6fa7c59985e))
* restore removal of custom marker types ([#401](https://github.com/axelcypher/obsidian-mapbox/issues/401)) ([73e1f4b](https://github.com/axelcypher/obsidian-mapbox/commit/73e1f4b46f796d679ed7a5efcf06c3916ba7f879))
* revert to webpack build to avoid collision with Map View (close [#384](https://github.com/axelcypher/obsidian-mapbox/issues/384)) ([8154392](https://github.com/axelcypher/obsidian-mapbox/commit/81543929c65b5c099fe9198784223cb6cdc426fa))
* scopes now properly inherit global scopes ([0b3b681](https://github.com/axelcypher/obsidian-mapbox/commit/0b3b681f26e84baf7017d68ae492ac6b172f996f))
* setup for npm release ([f00409a](https://github.com/axelcypher/obsidian-mapbox/commit/f00409ad2d812aadf66ed37ca5f9487d7d11e498))
* update Chinese translation (thank you @Wanxp) ([d0e19c6](https://github.com/axelcypher/obsidian-mapbox/commit/d0e19c615ad0e9fbba83f41269a4dcd9b0f14251))
* Update plugin name per Obsidian developer guidelines ([56bdbfc](https://github.com/axelcypher/obsidian-mapbox/commit/56bdbfcc02010aec809c2f70ee5ee56a072e2491))
* update release message ([b27bfa8](https://github.com/axelcypher/obsidian-mapbox/commit/b27bfa8c531facaffd4f689cafe1f5f32a4f67e9))
* Update release notes message ([8d8ec5c](https://github.com/axelcypher/obsidian-mapbox/commit/8d8ec5cdf48fbb4de26eb53c77b7c932ee7ea81f))
* version ([7f3f66b](https://github.com/axelcypher/obsidian-mapbox/commit/7f3f66b5dcbebcffe8b9040647eabe2fd08f5f61))
